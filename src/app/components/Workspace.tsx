...
import { FileText, Image, Video, Music, Star, Users, Clock, TrendingUp, Share, Download, EllipsisVertical, Zap, Sparkles } from 'lucide-react';
...
const workspaceContent = [
  ...
  { 
    id: 4, 
    title: 'Audio Notes', 
    subtitle: 'Client Meeting Recordings',
    type: 'audio', 
    icon: Music, 
    color: 'pink',
    progress: 30,
  ...
  { 
    ...
    subtitle: 'Visual Identity Standards',
    type: 'document', 
    icon: FileText, 
    color: 'yellow',
    progress: 100,
...
export function Workspace({ selectedNavItem, isMobile = false }: WorkspaceProps) {
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="px-2 py-0.5 rounded-full bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-400/30">
                    <span className="text-xs text-cyan-400 font-medium">6</span>
                  </div>
                </div>
                  ...
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="px-3 py-1 rounded-full bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-400/30">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-xs text-cyan-400 font-medium">6 Active</span>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className={`flex items-center justify-between ${isMobile ? 'pt-2' : 'pt-3'} border-t border-white/10`}>
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className={`text-gray-400 ${isMobile ? 'text-[10px]' : 'text-xs'}`}>{item.collaborators}</span>
                          </div>
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className={`text-gray-500 ${isMobile ? 'text-[10px]' : 'text-xs'}`}>{item.updated}</span>
                        </div>
                      </div>
                    </div>
                  </div>
