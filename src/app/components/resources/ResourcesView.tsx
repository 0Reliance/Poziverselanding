...
// 1. Inner Sidebar
function ResourcesSidebar({ selectedCategory, onSelectCategory }: { selectedCategory: string, onSelectCategory: (id: string) => void }) {
  return (
    <div className="w-64 border-r border-white/10 flex flex-col bg-black/20 backdrop-blur-xl">
      <div className="p-4">
        <h2 className="text-lg font-semibold text-white/90 mb-6 px-2">Resources</h2>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <Icon className={cn("w-4 h-4", isSelected ? "text-cyan-400" : "text-gray-500")} />
